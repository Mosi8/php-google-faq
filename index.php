    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-2">
                    <h1 class="m-0">Privacy e termini</h1>
                </div>
            </div>
            <div class="row ms_border">
                <div class="col-8">
                    <?php 
                    echo '<ul class="menulist">';
                    foreach ($menu as $value) {
                        if ($value == 'Domande Frequenti') {
                            echo '<li class="limenu active">'.$value."</li>";
                        }else{
                            echo '<li class="limenu">'.$value."</li>";
                        }
                    }
                    echo "</ul>"
                    ?>
        ...
        <div class="container py-5 mposition">
                    <?php ;
                    foreach ($domanderisposte as $value) {
                        echo "<div>";
